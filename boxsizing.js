(function(def) {
  ...
  var BoxsizingPolyfill = {};
  BoxsizingPolyfill.enable = def;
  if (typeof define !== "undefined" && typeof define === "function" && define.amd) {
    define("boxsizing-polyfill", [], function() {
      return BoxsizingPolyfill;
    });
  }
  this.BoxsizingPolyfill = BoxsizingPolyfill;
  ...
  */
  ...
  window.attachEvent("onresize", update, false);
  element.attachEvent("onpropertychange", checkPropertyChange, false);
  element.attachEvent("ondetach", restore, false);
